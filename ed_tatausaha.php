...
include 's_atas.php';
$sql = mysqli_query($koneksi, "select * from tatausaha");
...
?>
	...
	<div class="module">
	<br>
	<h2><span>EDIT TATA USAHA ANDA:</span></h2>
	<div class="module-table-body">
	<table id="myTable" class="tablesorter">
	<tr>
	<td>
	<form method="post" action="up_tatausaha.php">
	<div class="form-group col-md-6">
	<label>Id Tata Usaha: </label>
		<input type="text" class="form-control" value="<?php echo $hasil['id_tatausaha']; ?>" name="id_tatausaha"><br>
	<label>NIK: </label>
		<input type="text" class="form-control" value="<?php echo $hasil['nik']; ?>" name="nik"><br>
	<label>Nama Tata Usaha: </label>
		<input type="text" class="form-control" value="<?php echo $hasil['nama_tatausaha']; ?>" name="nama_tatausaha"><br>
