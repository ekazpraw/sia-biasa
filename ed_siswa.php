...
?>
	...
	<div class="module">
	<br>
	<h2><span>EDIT Siswa ANDA:</span></h2>
	<div class="module-table-body">
	<table id="myTable" class="tablesorter">
	<tr>
	<td>
	<form method="post" action="up_siswa.php">
	<div class="form-group col-md-6">
	<label>Id Siswa: </label>
		<input type="text" class="form-control" value="<?php echo $hasil['id_siswa']; ?>" name="id_siswa"><br>
	<label>NIS: </label>
		<input type="text" class="form-control" value="<?php echo $hasil['nis']; ?>" name="nis"><br>
	<label>Nama Siswa: </label>
		<input type="text" class="form-control" value="<?php echo $hasil['nama_siswa']; ?>" name="nama_siswa"><br>
